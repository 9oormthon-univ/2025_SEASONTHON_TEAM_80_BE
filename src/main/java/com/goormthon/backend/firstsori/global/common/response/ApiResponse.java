...
public record ApiResponse<T>(
    ...
    public static <T> ApiResponse<T> ok(@Nullable final T data) {
        return new ApiResponse<>(HttpStatus.OK, true, HttpStatus.OK.value(), "호출이 성공적으로 완료되었습니다.", data);
    }

    // 생성 성공 응답 (201 Created)
    public static <T> ApiResponse<T> created() {
        return new ApiResponse<>(HttpStatus.CREATED, true, HttpStatus.CREATED.value(), "성공적으로 생성되었습니다.", null);
    }
